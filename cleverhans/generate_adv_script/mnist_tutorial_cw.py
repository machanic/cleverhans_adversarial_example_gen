...
from cleverhans.generate_adv_script.config import ROOT_DATA_DIR
...
DATA_DIR = os.path.join(ROOT_DATA_DIR, 'MNIST/')
MODEL_PATH = os.path.join(ROOT_DATA_DIR, 'MNIST/MNIST')
TARGETED = False
